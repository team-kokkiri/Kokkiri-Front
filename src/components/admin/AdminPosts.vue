...
// ===== Computed =====
computed(() => {
  // props.postsData가 비어있으면 mock 데이터 사용
  return props.postsData.length > 0 ? props.postsData : mockPosts
})
