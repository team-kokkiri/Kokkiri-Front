                ...
                >
                  ...
                  <div class="btn-action-wrap">
                    <template v-if="item.type === 'invite'">
                      <button class="btn-accept" @click="handleAcceptInvitation(item.invitationId)">
                        {{ item.invitationId }}
                        수락</button>
                      <button class="btn-reject" @click="handleRejectInvitation(item.invitationId)">거절</button>
                    </template>
                    <template v-else>
